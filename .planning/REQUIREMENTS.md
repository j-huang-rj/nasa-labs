...
- [x] **AUTH-09**: DNSSEC signing with algorithm 13 (ECDSAP256SHA256), digest 2 (SHA-256) for forward zone + VPN reverse zone
- [x] **AUTH-10**: `172.16.{0|1}` reverse zones are NOT signed (per spec allowance)
...
- [x] **AUTO-02**: DS records generated and ready for OJ upload
